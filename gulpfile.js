...
(function (scope) {
  ...
  gulp.task('p-scripts:package:now', function () {
    var jsBundles = [distDir + '/scripts/euslugiinfo.min.js'];
  ...
  var scriptsBrowserify = function (env) {
    var jsBundles = ['app/scripts/euslugiinfo.js'];
...
(function (scope) {
  ...
  gulp.task('default', ['clean'], function () {
    runSequence(
      ['vulcanize', 'p-copy-bower-to-dist', 'p-copy-cname']
    );
  });
  ...
  gulp.task('p-copy-cname', function () {
  ...
  gulp.task('vulcanize:inline:now', function () {
    return gulp.src(distDir + '/euslugiinfo.html', {base: distDir + '/'})
      .pipe($.vulcanize({
  ...
  var vulcanizeWithExternalScriptsAndStyles = function (vulcanizeOptions) {
    return gulp.src(tmpDir + '/euslugiinfo.html')
